...
Versions before 0.22.5 also kept a plaintext copy in `settings.json`; updating removes it
automatically ([GHSA-7r7p-r4ph-w8m5](https://github.com/ldinino/bluebubbles-windows/security/advisories/GHSA-7r7p-r4ph-w8m5)).
Those older installers have been taken down, so just grab the latest.
